...
//            } */
         ...
         yesPopupForDelete = () => {
                    ...
                    fetch("http://localhost:8081/user/delete/"+this.deleteData.id)
      ...
      deleteMethod = (listValue) => {
       ...
       onSubmit = (event) => {
         ...
         if(this.name == "" || this.age == "" || this.gender == "" || !reg.test(this.age)) {
          ...
          fetch("http://localhost:8081/user/createUser",{method: "POST",
...
//           document.getElementById("formId").focus();
      ...
      yesPopUpForUpdate = () => {
                 fetch("http://localhost:8081/user/updateUser/"+this.id,{method: "POST",
                                          headers : new Headers({'content-type' : 'application/json'}),
                                          body:JSON.stringify({name : this.name, age : this.age,sex : this.gender}),
                                          }).then((res) => {res.json().then(res => console.log(res))})
